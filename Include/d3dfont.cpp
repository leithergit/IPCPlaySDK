...
//-----------------------------------------------------------------------------
HRESULT CD3DFont::InitDeviceObjects(IDirect3DDevice9Ex *pd3dDevice)
{
    HRESULT hr;
	...
	m_fTexCoords[96][0] = m_fTexCoords[0][0];
	m_fTexCoords[96][1] = m_fTexCoords[0][1];
	m_fTexCoords[96][2] = m_fTexCoords[0][2]*2;
	m_fTexCoords[96][3] = m_fTexCoords[0][3]*2;
                            ...
                            const TCHAR* strText, DWORD dwFlags )
{
    ...
    if( dwFlags & D3DFONT_CENTERED_X )
    {
        ...
        while( *strTextTmp )
        {
			...
			{
				tx1 = m_fTexCoords[96][0];
				tx2 = m_fTexCoords[96][2];
				strTextTmp++;
				bChs = true;
			}
			...
			if (bChs)
				w = (tx2 - tx1) *  m_dwTexWidth*2 / m_fTextScale;
    ...
    while( *strText )
    {
		...
		{
			tx1 = m_fTexCoords[96][0];
			ty1 = m_fTexCoords[96][1];
			tx2 = m_fTexCoords[96][2];
			ty2 = m_fTexCoords[96][3];
			strText++;
			bChs = true;
		}
